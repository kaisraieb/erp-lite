<template>
  <div
    class="flex items-center border-2 rounded-lg px-2 py-3 gap-2 my-8 text-lg dark:bg-gray-800 bg-gray-300 border-gray-500 text-gray-500"
  >
    ...
    <button
      ...
      v-if="props.showHide && props.type === 'password'"
